...
A status is part of a protocol contract. Choose it for semantics, not merely because its English phrase sounds convenient. A structured response body should add actionable detail. See [HTTP 426 Upgrade Required](HTTP%20426%20Upgrade%20Required.md) for an upgrade-specific example.
