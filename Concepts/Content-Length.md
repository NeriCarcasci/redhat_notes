...
It supports progress reporting, capacity planning, and some truncation checks. It is not universally present, and a [[Streaming HTTP downloads|streaming download]] can often read until the protocol marks the response complete.
